...
impl PluginCommandType {
    pub fn from_plugincommandtype(type_: BNPluginCommandType) -> PluginCommandType {
        match type_ {
            BNPluginCommandType_DefaultPluginCommand => PluginCommandType::Default,
            BNPluginCommandType_AddressPluginCommand => PluginCommandType::Address,
            BNPluginCommandType_RangePluginCommand => PluginCommandType::Range,
            BNPluginCommandType_FunctionPluginCommand => PluginCommandType::Function,
...
impl PluginCommand {
    ...
    pub fn execute(&self, bv: &BinaryView) -> Result<()> {
        ...
        Err(anyhow!(
            "PluginCommand type {:?} doesn't have the func",
            self.command_type()
        ))
    }
}
